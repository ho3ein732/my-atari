...
class Product(models.Model):
    ...
    created = jmodels.jDateTimeField(auto_now_add=True, verbose_name='تولید شده در')
    updated = jmodels.jDateTimeField(auto_now=True, verbose_name='بروزرسانی در')
...
class Image(models.Model):
    ...
    created = jmodels.jDateTimeField(auto_now_add=True, verbose_name='ساخته شد در')
...
class FavoriteProduct(models.Model):
    ...
    added_at = jmodels.jDateTimeField(auto_now_add=True, verbose_name='اضافه شده در')
