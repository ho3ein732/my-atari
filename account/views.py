...
def register_user(request):
    ...
    return render(request, '../templates/account/forms/register.html', {'form': form})
...
def verify_email(request):
    if request.method == 'POST':
        ...
        form = VerifyEmail()
    return render(request, '../templates/account/forms/verify_token.html', {'form': form})
...
def login_user(request):
    if request.method == 'POST':
        ...
        form = LoginForm()
    return render(request, '../templates/account/forms/login.html', {'form': form})
...
def complete_detail_account(request):
    ...
    return render(request, '../templates/account/account/detail.html', {'form': form})
...
def verifi_token_forget_password(request):
    ...
    return render(request, '../templates/account/account/confirm.html', {'form': form})
...
def forget_master_password(request):
    ...
    return render(request, '../templates/account/forms/forget_pass.html', {'form': form})
